...
export default function TakeQuizPage() {
  ...
  // If form is not published (Draft), show message
  if (form.published === false) {
    return (
      <div className={`min-h-screen py-10 px-4 ${fontClass}`} style={{ backgroundColor }}>
        ...
        >
          <div className="w-16 h-16 bg-zinc-100/10 text-zinc-500 rounded-full flex items-center justify-center mx-auto mb-4 border border-zinc-200/20">
          ...
          <p style={{ color: textColor, opacity: 0.8 }}>
            This form is currently in draft mode and is not visible to the public.
          </p>
        </div>
      </div>
    );
